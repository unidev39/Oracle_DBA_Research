...
# Public
192.16.6.48   pdbdr1.unidev.org.np        pdbdr1
192.16.6.49   pdbdr2.unidev.org.np        pdbdr2
...
# Virtual
192.16.6.50   pdbdr1-vip.unidev.org.np    pdbdr1-vip
192.16.6.51   pdbdr2-vip.unidev.org.np    pdbdr2-vip

# SCAN
192.16.6.52   pdbdr-scan.unidev.org.np    pdbdr-scan
192.16.6.53   pdbdr-scan.unidev.org.np    pdbdr-scan
192.16.6.54   pdbdr-scan.unidev.org.np    pdbdr-scan
*/
...
Sep 25 13:19:24 pdbdr1.unidev.org.np dnsmasq[57257]: using nameserver 192.16.4.11#53
Sep 25 13:19:24 pdbdr1.unidev.org.np dnsmasq[57257]: using nameserver 192.16.4.12#53
...
Sep 25 13:19:25 pdbdr1.unidev.org.np dnsmasq[57257]: using nameserver 192.16.4.11#53
Sep 25 13:19:25 pdbdr1.unidev.org.np dnsmasq[57257]: using nameserver 192.16.4.12#53
*/
...
-- Step 19 -->> On Node 1
[root@pdbdr1 ~]# nslookup 192.16.6.48
/*
48.6.16.192.in-addr.arpa        name = pdbdr1.unidev.org.np.
*/

-- Step 19.1 -->> On Node 1
[root@pdbdr1 ~]# nslookup 192.16.6.49
/*
49.6.16.192.in-addr.arpa        name = pdbdr2.unidev.org.np.
*/
...
ens160: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 192.16.6.48  netmask 255.255.255.0  broadcast 192.16.6.255
...
/*
ens160: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 192.16.6.49  netmask 255.255.255.0  broadcast 192.16.6.255
...
Sep 25 13:23:42 pdbdr1.unidev.org.np dnsmasq[1249]: using nameserver 192.16.4.11#53
Sep 25 13:23:42 pdbdr1.unidev.org.np dnsmasq[1249]: using nameserver 192.16.4.12#53
...
Sep 25 13:23:43 pdbdr1.unidev.org.np dnsmasq[1249]: using nameserver 192.16.4.11#53
Sep 25 13:23:43 pdbdr1.unidev.org.np dnsmasq[1249]: using nameserver 192.16.4.12#53
*/

-- Step 31.1 -->> On Both Node
[root@pdbdr1/pdbdr2 ~]# nslookup 192.16.6.48
/*
48.6.16.192.in-addr.arpa        name = pdbdr1.unidev.org.np.
*/

-- Step 31.2 -->> On Both Node
[root@pdbdr1/pdbdr2 ~]# nslookup 192.16.6.49
/*
49.6.16.192.in-addr.arpa        name = pdbdr2.unidev.org.np.
*/
...
/*
The authenticity of host 'pdbdr2 (192.16.6.49)' can't be established.
ECDSA key fingerprint is SHA256:6NantI4crKoxtXNREfhRZ4fxdEyl+3gYXHw3Es23exU.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added 'pdbdr2,192.16.6.49' (ECDSA) to the list of known hosts.
...
Listening Endpoints Summary...
  ...
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.48)(PORT=1521)))
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.50)(PORT=1521)))
Services Summary...
...
Listening Endpoints Summary...
  ...
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.53)(PORT=1521)))
...
Listening Endpoints Summary...
  ...
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.54)(PORT=1521)))
The listener supports no services
The command completed successfully
*/
...
Listening Endpoints Summary...
  (DESCRIPTION=(ADDRESS=(PROTOCOL=ipc)(KEY=LISTENER)))
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.49)(PORT=1521)))
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.51)(PORT=1521)))
Services Summary...
Service "+ASM" has 1 instance(s).
...
Listening Endpoints Summary...
  ...
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.16.6.52)(PORT=1521)))
The listener supports no services
The command completed successfully
*/
...
/*
The authenticity of host 'pdbdr1 (192.16.6.48)' can't be established.
ECDSA key fingerprint is SHA256:B1/tTpbAVGmVTp+5F0MRHCwB1ayv1KW34IFg6GQZ7kM.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added 'pdbdr1,192.16.6.48' (ECDSA) to the list of known hosts.
