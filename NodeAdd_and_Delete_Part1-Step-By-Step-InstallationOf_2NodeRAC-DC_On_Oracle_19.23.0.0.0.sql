...
Sep 25 10:51:09 pdb1.unidev.org.np dnsmasq[56191]: using nameserver 192.160.4.11#53
Sep 25 10:51:09 pdb1.unidev.org.np dnsmasq[56191]: using nameserver 192.160.4.12#53
...
-- Step 19 -->> On Node 1
[root@pdb1 ~]# nslookup 192.160.6.21
/*
21.6.160.192.in-addr.arpa        name = pdb1.unidev.org.np.
*/

-- Step 19.1 -->> On Node 1
[root@pdb1 ~]# nslookup 192.160.6.22
/*
22.6.160.192.in-addr.arpa        name = pdb2.unidev.org.np.
*/
...
ens160: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 192.160.6.21  netmask 255.255.255.0  broadcast 192.160.6.255
...
/*
ens160: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 192.160.6.22  netmask 255.255.255.0  broadcast 192.160.6.255
...
Sep 25 10:56:09 pdb1.unidev.org.np dnsmasq[1270]: using nameserver 192.160.4.11#53
Sep 25 10:56:09 pdb1.unidev.org.np dnsmasq[1270]: using nameserver 192.160.4.12#53
...
[root@pdb1/pdb2 ~]# nslookup 192.160.6.21
/*
21.6.160.192.in-addr.arpa        name = pdb1.unidev.org.np.
*/

-- Step 31.2 -->> On Both Node
[root@pdb1/pdb2 ~]# nslookup 192.160.6.22
/*
22.6.160.192.in-addr.arpa        name = pdb2.unidev.org.np.
*/
...
/*
The authenticity of host 'pdb2 (192.160.6.22)' can't be established.
ECDSA key fingerprint is SHA256:6NantI4crKoxtXNREfhRZ4fxdEyl+3gYXHw3Es23exU.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added 'pdb2,192.160.6.22' (ECDSA) to the list of known hosts.
