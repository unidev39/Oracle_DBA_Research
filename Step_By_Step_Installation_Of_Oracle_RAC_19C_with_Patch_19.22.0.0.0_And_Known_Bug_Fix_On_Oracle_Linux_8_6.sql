...
PDBDB1 =
  (DESCRIPTION =
    (ADDRESS = (PROTOCOL = TCP)(HOST = 172.16.6.21)(PORT = 1521))
    (CONNECT_DATA =
      (SERVER = DEDICATED)
      (SERVICE_NAME = pdbdb)
    )
...
SOURCEPDB =
  (DESCRIPTION =
    (ADDRESS = (PROTOCOL = TCP)(HOST = sourcepdb-scan)(PORT = 1521))
    (CONNECT_DATA =
      (SERVER = DEDICATED)
...
-- Step 158.1 -->> On TARGETDB Server (Heap/Partitions tables import using Network Link)
[oracle@pdb1 ~]$ tnsping SOURCEPDB
/*
TNS Ping Utility for Linux: Version 19.0.0.0.0 - Production on 02-JUN-2024 14:47:35
...
Attempting to contact (DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = sourcepdb-scan)(PORT = 1521)) (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = sourcepdb)))
OK (20 msec)
*/

-- Step 158.2 -->> On TARGETDB Server (Heap/Partitions tables import using Network Link)
[oracle@pdb1/pdb2 ~]$ mkdir -p /home/oracle/dump_dir
[oracle@pdb1/pdb2 ~]$ chmod -R 775 /home/oracle/dump_dir/

-- Step 158.3 -->> On TARGETDB Server (Heap/Partitions tables import using Network Link)
[oracle@pdb1 ~]$ sqlplus sys/"P#ssw0rd"@invpdb as sysdba
/*
SQL*Plus: Release 19.0.0.0.0 - Production on Sun Jun 2 14:46:04 2024
Version 19.22.0.0.0
...
SQL> CREATE PUBLIC DATABASE LINK SRC_BACKUP_PROD CONNECT TO BACKUP IDENTIFIED BY "backup#k5k!" USING 'SOURCEPDB'; <= Source DB schma name and credentials

Database link created.

SQL> select * FROM dual@SRC_BACKUP_PROD;

D
-
X

SQL> CREATE OR REPLACE DIRECTORY dump_dir AS '/home/oracle/dump_dir/';
...
-- Step 159 -->> On SOURCEPDB Server (Heap/Partitions tables import using Network Link)
...
-- Step 159.3 -->> On SOURCEPDB Server (Heap/Partitions tables import using Network Link)
COMMIT;

-- Step 160 -->> On TARGETDB Server (Heap/Partitions tables import using Network Link)
[oracle@pdb1 ~]$ impdp BACKUP/B8\#cKu\#P@invpdb schemas=BACKUP \
LOGFILE=SRC_BACKUP.log DIRECTORY=DUMP_DIR \
...
Starting "BACKUP"."SYS_IMPORT_SCHEMA_01":  BACKUP/********@invpdb schemas=BACKUP LOGFILE=SRC_BACKUP.log DIRECTORY=DUMP_DIR NETWORK_LINK=SRC_BACKUP_PROD PARALLEL=4 include=table:"IN ('TBL_IMPORT_HEAP' )" REMAP_SCHEMA=BACKUP:BACKUP REMAP_TABLESPACE=TBS_BACKUP:TBS_BACKUP
Estimate in progress using BLOCKS method...
Processing object type SCHEMA_EXPORT/TABLE/TABLE_DATA
Total estimation using BLOCKS method: 128 KB
Processing object type SCHEMA_EXPORT/TABLE/TABLE
. . imported "BACKUP"."TBL_IMPORT_HEAP"                    1000 rows
Job "BACKUP"."SYS_IMPORT_SCHEMA_01" successfully completed at Sun Jun 2 15:15:11 2024 elapsed 0 00:00:22
*/
...
Connected to: Oracle Database 19c Enterprise Edition Release 19.0.0.0.0 - Production
Starting "BACKUP"."SYS_IMPORT_SCHEMA_01":  BACKUP/********@invpdb schemas=BACKUP LOGFILE=SRC_BACKUP_P.log DIRECTORY=DUMP_DIR NETWORK_LINK=SRC_BACKUP_PROD PARALLEL=4 include=table:"IN ('TBL_BIG_ALBUM_SALES_PT' )" REMAP_SCHEMA=BACKUP:BACKUP REMAP_TABLESPACE=TBS_BACKUP:TBS_BACKUP
Estimate in progress using BLOCKS method...
Processing object type SCHEMA_EXPORT/TABLE/TABLE_DATA
Total estimation using BLOCKS method: 8 MB
Processing object type SCHEMA_EXPORT/TABLE/TABLE
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2008"      10000 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2001"          0 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2002"          0 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2003"          0 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2004"          0 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2005"          0 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2006"          0 rows
. . imported "BACKUP"."TBL_BIG_ALBUM_SALES_PT":"ALBUM_2007"          0 rows
Job "BACKUP"."SYS_IMPORT_SCHEMA_01" successfully completed at Sun Jun 2 15:15:46 2024 elapsed 0 00:00:27
*/
